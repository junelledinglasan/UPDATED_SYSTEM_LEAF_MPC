            ...
            <div>
              ...
              {appStatus === "Pending" && (
                <div style={{background:"#fff8e1",border:"1px solid #ffe082",borderRadius:10,padding:"12px 16px",fontSize:13,color:"#5d4037"}}>
                  ⏳ Your application is currently under review. The admin or staff will notify you once it has been processed.
                </div>
              )}
              {appStatus === "Approved" && (
                <div style={{background:"#e8f5e9",border:"1px solid #a5d6a7",borderRadius:10,padding:"12px 16px",fontSize:13,color:"#1b5e20"}}>
                  ✅ Your application has been <strong>approved!</strong> Please visit the LEAF MPC office to complete the process and become an official member.
                </div>
              )}
              {appStatus === "Rejected" && (
                <div>
